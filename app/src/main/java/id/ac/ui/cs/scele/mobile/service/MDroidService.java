package id.ac.ui.cs.scele.mobile.service;
...
import id.ac.ui.cs.scele.mobile.task.ContactSyncTask;
import id.ac.ui.cs.scele.mobile.task.CourseContentSyncTask;
import id.ac.ui.cs.scele.mobile.task.DiscussionSyncTask;
import id.ac.ui.cs.scele.mobile.task.EventSyncTask;
import id.ac.ui.cs.scele.mobile.task.ForumSyncTask;
import id.ac.ui.cs.scele.mobile.task.MessageSyncTask;
import id.ac.ui.cs.scele.mobile.task.PostSyncTask;
import id.ac.ui.cs.scele.mobile.task.UserSyncTask;
