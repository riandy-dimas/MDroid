...
import id.ac.ui.cs.scele.mobile.helper.FormValidate;
import id.ac.ui.cs.scele.mobile.helper.Param;
import id.ac.ui.cs.scele.mobile.task.LoginTask;
import id.ac.ui.cs.scele.mobile.view.LoginStatusViewHolder;
...
public class NormalLoginFragment extends Fragment {
	...
	private void doNormalLogin() {
		...
		String mUrl = getResources().getString(R.string.scele_url);
